...
Module IV
    Public Enum ValidationType
        ...
        Phone_Number = 5
    End Enum
    Public Sub AssignValidation(ByRef CTRL As System.Windows.Forms.TextBox, ByVal Validation_Type As ValidationType)
        Dim txt As System.Windows.Forms.TextBox = CTRL
    ...
    Public Sub number_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Dim numbers As System.Windows.Forms.TextBox = sender
    ...
    Public Sub NotNull_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim No As System.Windows.Forms.TextBox = sender
    ...
    Public Sub Email_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim Email As System.Windows.Forms.TextBox = sender
        If Email.Text <> "" Then
