...
Public Class EconomySeats
    ...
    Private Sub selectseats_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim sql2 As String = $"SELECT ""Economy_No"" FROM ""Flights"" WHERE ""FlightID"" = '{LoginDetails.FlightID}'"
                    ...
                    If ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
                        ...
                        For Each row As DataRow In ds.Tables(0).Rows
                            ...
                            For Each item In seats
                                ...
                                Dim colu As Integer
                                If seat(0) = "E" Then
                                    If (Integer.Parse(seat(2))) < 4 Then
                                        colu = Integer.Parse(seat(2)) - 1
                                    ElseIf (Integer.Parse(seat(2))) < 7 Then
    ...
    Private Sub pctbs_Click(sender As Object, e As EventArgs)
        ...
        Else
            colu = (TableLayoutPanel1.GetPositionFromControl(sender).Column) - 1
        End If
        Dim nameee As String = "E" & row & colu
    ...
    Private Sub EconomySeats_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Seats.Show()
    End Sub
End Class