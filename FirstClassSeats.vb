...
Public Class FirstClassSeats
    ...
    Private Sub selectseats_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim sql2 As String = $"SELECT ""First_Class_No"" FROM ""Flights"" WHERE ""FlightID"" = '{LoginDetails.FlightID}'"
        ...
        End Try
        Dim nooffullrows As Integer = noofseats / 3
        Dim aec As Integer = (noofseats Mod 3) / 3
        Dim temp As Integer = noofseats + (nooffullrows * 2) + aec
        Dim pctbs(temp) As PictureBox
        Dim mainno As Integer = 1
                    ...
                    If ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
                        ...
                        For Each row As DataRow In ds.Tables(0).Rows
                            ...
                            For Each item In seats
                                ...
                                Dim colu As Integer
                                If seat(0) = "F" Then
                                    If (Integer.Parse(seat(2))) < 2 Then
                                        colu = Integer.Parse(seat(2)) - 1
                                    ElseIf (Integer.Parse(seat(2))) < 3 Then
    ...
    Private Sub pctbs_Click(sender As Object, e As EventArgs)
        ...
        Dim colu As String
        If (TableLayoutPanel1.GetPositionFromControl(sender).Column) < 1 Then
            colu = (TableLayoutPanel1.GetPositionFromControl(sender).Column) + 1
        ElseIf (TableLayoutPanel1.GetPositionFromControl(sender).Column) < 3 Then
            colu = (TableLayoutPanel1.GetPositionFromControl(sender).Column)
        Else
            colu = (TableLayoutPanel1.GetPositionFromControl(sender).Column) - 1
        End If
        Dim nameee As String = "F" & row & colu
    ...
    Private Sub FirstClassSeats_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Seats.Show()
    End Sub
End Class